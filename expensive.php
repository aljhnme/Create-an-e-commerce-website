	...
	<main>
		<div class="top_banner version_2">
			<div class="opacity-mask d-flex align-items-center" data-opacity-mask="rgba(0, 0, 0, 0)">
				<div class="container">
					<div class="d-flex justify-content-center"><h1>The most valuable products
					</h1></div>
				</div>
			</div>
		...
		<!-- /top_banner -->
			...
			<div class="toolbox elemento_stick">
				...
				<ul class="clearfix">
					...
					<li>
						...
						<a href="expensivee.php"><i class="ti-view-list"></i></a>
					</li>
					<li>
			...
			<div class="row small-gutters">
				...
				<div class="col-6 col-md-4 col-xl-3">
					<div class="grid_item">
						<figure>
							<span class="ribbon off"><?php echo $row['k'];  ?></span>
							 <?php
                              if ($row['new'] == "nwe") 
                              {
                ...
                if ($stmmo->rowcount() == 0) 
                {
                	echo '<div class="container"><div class="row" id="appSummary"><div class="col text-center"><h1><img src="no_p.png" style="width:35%;"/></h1><p class="lead">There are no products</p></div></div></div>';
                   }
				?>
			</div>	
		</div>
